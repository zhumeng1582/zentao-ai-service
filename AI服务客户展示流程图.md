...
本方案在现有项目管理平台基础上增加独立 AI 服务，为用户提供 Bug 智能分析、文档问答、反馈详情辅助和全局 AI 客服能力。
...
> 用户可以在 Bug、文档、反馈以及其他业务页面直接使用 AI。系统会根据当前页面自动限定 AI 的查询范围，并在调用 AI 前通过项目管理平台重新检查用户权限。AI 输出的问题分析、文档答案和操作指导尽量附带资料来源；涉及修改业务数据时，必须由用户人工确认，AI 不会自动关闭问题或修改项目状态。
